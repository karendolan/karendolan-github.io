    ...
    wrangleData(){
        ...
        if (selectedTimeRange.length !== 0){
            ...
            tableObject.covidData.forEach( row => {
                ...
                if (selectedTimeRange[0].getTime() <= tableObject.parseDate(row.submission_date).getTime()
                    && tableObject.parseDate(row.submission_date).getTime() <= selectedTimeRange[1].getTime() ){
